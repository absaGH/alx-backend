...
def get_timezone():
    """ determine appropriate time zone """
    locTimezone = request.args.get('timezone')
    if locTimezone in pytz.all_timezones:
        return locTimezone
    else:
        raise pytz.exceptions.UnknownTimeZoneError
    userId = request.args.get('login_as')
    locTimezone = users[int(userId)]['timezone']
    if locTimezone in pytz.all_timezones:
        return locTimezone
    else:
        raise pytz.exceptions.UnknownTimeZoneError
